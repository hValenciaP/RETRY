...
/* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "IDCODIGOGENERAL";
       
    /* DB table to use */
    $sTable = "SAS_LISTADO_PERSONAL_PRO";
    /* Database connection information */
    $gaSql['user']       = "sa";
    $gaSql['password']   = 'usersql$$nisira';
    $gaSql['db']         = "SATURNO_TEST";
    $gaSql['server']     = "192.168.1.7";
    ...
    */
    $aColumns = array('IDCODIGOGENERAL', 'IDPLANILLA','APENOM','FECHA_NACIMIENTO','SEXO','DESCR_CORTO','NRODOCUMENTO');
